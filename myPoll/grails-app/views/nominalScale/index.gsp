...
<html>
	...
	<body>
		<a href="#list-nominalScale" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-nominalScale" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${nominalScaleInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
