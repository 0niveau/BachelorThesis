...
<html>
	...
	<body>
		<a href="#list-ordinalScale" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-ordinalScale" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${ordinalScaleInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
