...
<div class="fieldcontain ${hasErrors(bean: pollInstance, field: 'opinions', 'error')} ">
	<label for="opinions">
		<g:message code="poll.opinions.label" default="Opinions" />
...
<li class="add">
<g:link controller="opinion" action="create" params="['poll.id': pollInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'opinion.label', default: 'Opinion')])}</g:link>
</li>
</ul>
